...
<body>
	...
	<nav class="navbar navbar-default  ">
		...
		<div class="container">
			...
			<div class="panel-heading">学生端</div>
			<div class="panel-body">
				<!-- ***************************************************8 -->
				<div class="col-md-6 col-sm-4">
					<a href="jsp/user/studentinfo.jsp" class="thumbnail"> <img
						src="images/学生端图片/studentInfo.png"
						style="height: 140px; width: 140px; display: block;" alt="">
					</a>
				...
				<!-- ***************************************************8 -->
				<div class="col-md-6 col-sm-4">
					<a href="teacher/selectTeachers" class="thumbnail"> <img
						src="images/学生端图片/comment.png"
						style="height: 140px; width: 140px; display: block;" alt="">
					</a>
					<div class="caption" style="text-align: center;">
						<p>学生评教</p>
		...
		<!-- ******************************************************************************************************************** -->
		<div class="panel panel-info">
			<div class="panel-heading">教务平台</div>
			<div class="panel-body">
				<!-- ***************************************************8 -->
				<div class="col-md-6 col-sm-4">
					<a href="mark/selectMark" class="thumbnail"> <img
						src="images/学生端图片/score.png"
						style="height: 140px; width: 140px; display: block;" alt="">
					</a>
					<div class="caption" style="text-align: center;">
						<p>课程成绩查询</p>
				...
				<!-- ***************************************************8 -->
				<div class="col-md-6 col-sm-4">
					<a href="jsp/user/courseselect.jsp" class="thumbnail"> <img
						src="images/学生端图片/course.png"
						style="height: 140px; width: 140px; display: block;" alt="">
					</a>
					<div class="caption" style="text-align: center;">
						<p>学期课程表查询</p>
